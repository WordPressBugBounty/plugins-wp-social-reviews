...
class Helper
{
    public static function getSvgIcons($configs = [], $channel = [], $type = '')
    {
        ...
        $icons        = array(
            'icon1'     => '<svg class="wpsr-icon-whatsapp" version="1.1" id="Layer_1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                <g>
            ...
            'icon2'     => '<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 58.18 43.64">
            ...
            'icon3'     => '<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 58.21 50.91">
                            <g id="Layer_2" data-name="Layer 2">
                                <g id="Layer_1-2" data-name="Layer 1">
                                    <path class="wpsr-fm-bubble-btn-svg-path-1"
            ...
            'icon4'     => '<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 58.26 58.26">
                            <g id="Layer_2" data-name="Layer 2">
                                <g id="Layer_1-2" data-name="Layer 1">
                                    <path class="wpsr-fm-bubble-btn-svg-path-1"
            ...
            'icon5'     => '<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 56.36 56.36">
                            <g id="Layer_2" data-name="Layer 2">
                                <g id="Layer_1-2" data-name="Layer 1">
                                    <path class="wpsr-fm-bubble-btn-svg-path-1"
            ...
            'icon6'     => '<svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 50.91 58.18">
                            <g id="Layer_2" data-name="Layer 2">
                                <g id="Layer_1-2" data-name="Layer 1">
                                    <path class="wpsr-fm-bubble-btn-svg-path-1"
            ...
            'icon7'     => '<svg class="wpsr-icon-messenger" version="1.1" id="Capa_1" xmlns="https://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512.05 512.05" style="enable-background:new 0 0 512.05 512.05;" xml:space="preserve">
            ...
            'whatsapp'  => '<svg width="32" height="32" version="1.1" id="Layer_1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                <g>
                    <path class="wpsr-path-1" d="M378.853,294.202c-0.997-0.479-38.324-18.859-44.956-21.246c-2.708-0.972-5.609-1.922-8.694-1.922
                                        c-5.04,0-9.274,2.512-12.572,7.446c-3.729,5.542-15.016,18.736-18.503,22.678c-0.456,0.52-1.077,1.142-1.45,1.142
                                        c-0.334,0-6.111-2.379-7.86-3.138c-40.041-17.393-70.433-59.219-74.601-66.272c-0.595-1.014-0.62-1.474-0.625-1.474
    ...
    public static function encodeCredentials($credential)
    {
        ...
        if(strpos($credential, '?users=') !== false){
            $parts = explode('=', $credential, 2);
            if (isset($parts[1]) && str_contains($parts[1] ?? '', '@')) {
                $credential = $parts[0] . '=' . urlencode(trim($parts[1]));
            }
        }
    ...
    public static function getPrefilledPlatform()
    {
        return $platforms = ['whatsapp', 'sms'];
    }
}